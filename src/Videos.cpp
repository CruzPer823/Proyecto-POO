...
double Videos :: mostrarCalificacion(std::string datos){ //el string datos pienso que sea le vector del txt, pero no c como se mete
  //que haga una cagada para mostrar la calificacion de los videos xd

}

double Videos ;; calificarVideo(std::string datos){
